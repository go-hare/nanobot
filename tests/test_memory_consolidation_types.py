...
Regression test for https://github.com/HKUDS/emoticorebot/issues/1042
...
from emoticorebot.agent.memory import MemoryStore
from emoticorebot.providers.base import LLMResponse, ToolCallRequest
