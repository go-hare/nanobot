...
def _make_loop():
    ...
    with patch("emoticorebot.agent.loop.ContextBuilder"), \
         patch("emoticorebot.agent.loop.SessionManager"), \
         patch("emoticorebot.agent.loop.SubagentManager") as MockSubMgr:
