...
def mock_prompt_session():
    ...
    with patch("emoticorebot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("emoticorebot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("emoticorebot.cli.commands.PromptSession") as MockSession, \
         patch("emoticorebot.cli.commands.FileHistory") as MockHistory, \
