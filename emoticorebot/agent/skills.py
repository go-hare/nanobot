...
class SkillsLoader:
    ...
    def _parse_emoticorebot_metadata(self, raw: str) -> dict:
        """Parse skill metadata JSON from frontmatter (supports emoticorebot and openclaw keys)."""
        try:
            data = json.loads(raw)
    ...
    def _get_skill_meta(self, name: str) -> dict:
        """Get emoticorebot metadata for a skill (cached in frontmatter)."""
