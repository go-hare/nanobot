...
from emoticorebot.core.contracts import FusionPolicy, TurnSignals
...
class PolicyEngine:
    ...
    def make_policy(
        ...
        if isinstance(runtime_adjustment, dict):
            ...
            if isinstance(tone_pref, str):
                normalized_tone = tone_pref.strip()
                if normalized_tone in allowed_tones:
